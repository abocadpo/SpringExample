package com.abocado.spring.ex.jpa;
...
import com.abocado.spring.ex.jpa.service.StudentService;
...
//		student.setPhoneNumber("010-1234-5678");
		...
		Student student = Student.builder().name("김인규").dreamJob("개발자").phoneNumber("010-1234-5678").build();
